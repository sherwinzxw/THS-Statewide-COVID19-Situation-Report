...
const RespiratoryClinicPresentations = props => {
  ...
  return <div className="table-container col-12"><table renderHash={renderHash} className="RespiratoryClinicPresentationsTable">
    ...
    <tbody>
      ...
      <RollingRow
        label="New Clinic(s)"
        value={value[controlLabelMap['New Clinic(s)']]}
        onChangeValue={(newValue) => {
          onValueItemChange(controlLabelMap['New Clinic(s)'], newValue)
        }}
      />
      ...
      <tr className="light-grey">
        ...
        <td>
          {formatNumber(
            ...
            parseIntOrZero(findValueForDayRange('New Clinic(s)', -6))
          )}
        </td>
        <td>
          {formatNumber(
            ...
            parseIntOrZero(findValueForDayRange('New Clinic(s)', -5))
          )}
        </td>
        <td>
          {formatNumber(
            ...
            parseIntOrZero(findValueForDayRange('New Clinic(s)', -4))
          )}
        </td>
        <td>
          {formatNumber(
            ...
            parseIntOrZero(findValueForDayRange('New Clinic(s)', -3))
          )}
        </td>
        <td>
          {formatNumber(
            ...
            parseIntOrZero(findValueForDayRange('New Clinic(s)', -2))
          )}
        </td>
        <td>
          {formatNumber(
            ...
            parseIntOrZero(findValueForDayRange('New Clinic(s)', -1))
          )}
        </td>
        <td>
          {formatNumber(
            ...
            parseIntOrZero(findValueForDayRange('New Clinic(s)', 0))
          )}
        </td>
        <td>
          {([
